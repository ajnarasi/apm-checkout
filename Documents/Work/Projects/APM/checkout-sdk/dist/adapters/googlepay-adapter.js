...
export function createGooglepayAdapter() {
    let eventBus = null;
    let config = null;
    ...
    return {
        ...
        getServerHandoff() { return { endpoint: '/api/googlepay/process', method: 'POST', body: { amount: numberToString(config?.amount.total ?? 0), currency: config?.amount.currency ?? 'USD' } }; },
...
//# sourceMappingURL=googlepay-adapter.js.map