...
export function createWechatpayAdapter() {
    ...
    return {
        ...
        getServerHandoff() { return { endpoint: '/api/wechatpay/order', method: 'POST', body: { amount: multiply100(config?.amount.total ?? 0), currency: config?.amount.currency ?? 'USD' } }; },
...
//# sourceMappingURL=wechatpay-adapter.js.map