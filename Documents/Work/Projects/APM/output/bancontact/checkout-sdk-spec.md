# Bancontact — Checkout SDK Integration Spec
...
|---|---|---|
| BE | EUR | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with Bancontact" | "Pay with Bancontact" |
| **Brand Color** | #005498 | #005498 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/bancontact.svg | — |
...
3. render(container) → Render branded "Bancontact" button (#005498)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=BANCONTACT
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'BANCONTACT', amount, currency: 'EUR' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ BANCONTACT) | Yes |
