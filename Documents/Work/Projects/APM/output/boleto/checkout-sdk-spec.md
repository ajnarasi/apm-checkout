# Boleto — Checkout SDK Integration Spec
...
|---|---|---|
| **Button Label** | "Pay with Boleto" | "Pay with Boleto" |
| **Brand Color** | #F7941E | #F7941E |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/boleto.svg | — |
| **Voucher Expiry** | 7 days | — |
...
3. render(container) → Render branded "Boleto" button (#F7941E)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=BOLETO
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'BOLETO', amount, currency: 'BRL' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ BOLETO) | Yes |
