# DANA — Checkout SDK Integration Spec
...
|---|---|---|
| **Button Label** | "Pay with DANA" | "Pay with DANA" |
| **Brand Color** | #118EEA | #118EEA |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/dana.svg | — |
...
3. render(container) → Render branded "DANA" button (#118EEA)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=DANA
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'DANA', amount, currency: 'IDR' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ DANA) | Yes |
