# GCash — Checkout SDK Integration Spec
...
|---|---|---|
| PH | PHP | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with GCash" | "Pay with GCash" |
| **Brand Color** | #007DFE | #007DFE |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/gcash.svg | — |
...
3. render(container) → Render branded "GCash" button (#007DFE)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=GCASH
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'GCASH', amount, currency: 'PHP' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ GCASH) | Yes |
