# iDEAL — Checkout SDK Integration Spec
...
|---|---|---|
| NL | EUR | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with iDEAL" | "Pay with iDEAL" |
| **Brand Color** | #CC0066 | #CC0066 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/ideal.svg | — |
| **Bank Selection** | ABN AMRO, ING, Rabobank, SNS, ASN, Triodos, Knab, Bunq, N26 | — |
...
3. render(container) → Render branded "iDEAL" button (#CC0066)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=IDEAL
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'IDEAL', amount, currency: 'EUR' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ IDEAL) | Yes |
