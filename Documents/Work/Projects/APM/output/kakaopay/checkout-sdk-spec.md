# KakaoPay — Checkout SDK Integration Spec
...
|---|---|---|
| KR | KRW | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with KakaoPay" | "Pay with KakaoPay" |
| **Brand Color** | #FFEB00 | #FFEB00 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/kakaopay.svg | — |
...
3. render(container) → Render branded "KakaoPay" button (#FFEB00)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=KAKAOPAY
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'KAKAOPAY', amount, currency: 'KRW' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ KAKAOPAY) | Yes |
