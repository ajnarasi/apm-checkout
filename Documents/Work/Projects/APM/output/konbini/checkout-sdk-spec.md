# Konbini — Checkout SDK Integration Spec
...
|---|---|---|
| **Button Label** | "Pay with Konbini" | "Pay with Konbini" |
| **Brand Color** | #FF6600 | #FF6600 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/konbini.svg | — |
| **Voucher Expiry** | 3 days | — |
| **Store Selection** | 7-Eleven, Lawson, FamilyMart | — |
...
3. render(container) → Render branded "Konbini" button (#FF6600)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=KONBINI
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'KONBINI', amount, currency: 'JPY' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ KONBINI) | Yes |
