# LINE Pay — Checkout SDK Integration Spec
...
|---|---|---|
| TH | THB | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with LINE Pay" | "Pay with LINE Pay" |
| **Brand Color** | #00C300 | #00C300 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/linepay.svg | — |
...
3. render(container) → Render branded "LINE Pay" button (#00C300)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=LINEPAY
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'LINEPAY', amount, currency: 'THB' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ LINEPAY) | Yes |
