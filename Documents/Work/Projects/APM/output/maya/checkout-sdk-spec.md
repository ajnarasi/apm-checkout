# Maya — Checkout SDK Integration Spec
...
|---|---|---|
| **Button Label** | "Pay with Maya" | "Pay with Maya" |
| **Brand Color** | #01C853 | #01C853 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/maya.svg | — |
...
3. render(container) → Render branded "Maya" button (#01C853)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=MAYA
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'MAYA', amount, currency: 'PHP' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ MAYA) | Yes |
