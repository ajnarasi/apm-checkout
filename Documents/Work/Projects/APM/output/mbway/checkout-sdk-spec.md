# MB WAY — Checkout SDK Integration Spec
...
|---|---|---|
| PT | EUR | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with MB WAY" | "Pay with MB WAY" |
| **Brand Color** | #FF0000 | #FF0000 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/mbway.svg | — |
| **Phone Input** | Portuguese mobile format required | — |
...
3. render(container) → Render branded "MB WAY" button (#FF0000)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=MBWAY
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'MBWAY', amount, currency: 'EUR' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ MBWAY) | Yes |
