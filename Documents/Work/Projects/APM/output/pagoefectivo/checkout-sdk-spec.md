# PagoEfectivo — Checkout SDK Integration Spec

## Section A: SDK Metadata

| Property | Value |
|---|---|
| **APM Code** | PAGOEFECTIVO |
| **Display Name** | PagoEfectivo |
...
|---|---|---|
| PE | PEN | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with PagoEfectivo" | "Pay with PagoEfectivo" |
| **Brand Color** | #FFCC00 | #FFCC00 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/pagoefectivo.svg | — |
...
3. render(container) → Render branded "PagoEfectivo" button (#FFCC00)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=PAGOEFECTIVO
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'PAGOEFECTIVO', amount, currency: 'PEN' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ PAGOEFECTIVO) | Yes |
