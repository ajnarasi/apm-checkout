# Pix — Checkout SDK Integration Spec
...
|---|---|---|
| BR | BRL | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with Pix" | "Pay with Pix" |
| **Brand Color** | #32BCAD | #32BCAD |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/pix.svg | — |
...
3. render(container) → Render branded "Pix" button (#32BCAD)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=PIX
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'PIX', amount, currency: 'BRL' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ PIX) | Yes |
