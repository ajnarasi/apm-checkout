# PostFinance — Checkout SDK Integration Spec

## Section A: SDK Metadata

| Property | Value |
|---|---|
| **APM Code** | POSTFINANCE |
| **Display Name** | PostFinance |
...
|---|---|---|
| **Button Label** | "Pay with PostFinance" | "Pay with PostFinance" |
| **Brand Color** | #FFCC00 | #FFCC00 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/postfinance.svg | — |
...
3. render(container) → Render branded "PostFinance" button (#FFCC00)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=POSTFINANCE
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'POSTFINANCE', amount, currency: 'CHF' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ POSTFINANCE) | Yes |
