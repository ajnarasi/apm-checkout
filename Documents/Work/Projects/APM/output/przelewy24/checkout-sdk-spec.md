# Przelewy24 — Checkout SDK Integration Spec
...
|---|---|---|
| PL | PLN | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with Przelewy24" | "Pay with Przelewy24" |
| **Brand Color** | #D13239 | #D13239 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/przelewy24.svg | — |
| **Bank Selection** | mBank, PKO BP, ING, Santander, Pekao, Alior, BNP Paribas | — |
...
3. render(container) → Render branded "Przelewy24" button (#D13239)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=PRZELEWY24
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'PRZELEWY24', amount, currency: 'PLN' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ PRZELEWY24) | Yes |
