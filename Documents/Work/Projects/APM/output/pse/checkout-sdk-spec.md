# PSE — Checkout SDK Integration Spec
...
|---|---|---|
| **Button Label** | "Pay with PSE" | "Pay with PSE" |
| **Brand Color** | #005BAA | #005BAA |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/pse.svg | — |
| **Bank Selection** | Bancolombia, Davivienda, BBVA, Banco de Bogota, Nequi | — |
...
3. render(container) → Render branded "PSE" button (#005BAA)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=PSE
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'PSE', amount, currency: 'COP' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ PSE) | Yes |
