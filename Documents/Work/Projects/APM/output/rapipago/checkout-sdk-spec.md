# RapiPago — Checkout SDK Integration Spec
...
|---|---|---|
| **Button Label** | "Pay with RapiPago" | "Pay with RapiPago" |
| **Brand Color** | #009EDB | #009EDB |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/rapipago.svg | — |
| **Voucher Expiry** | 72 hours | — |
...
3. render(container) → Render branded "RapiPago" button (#009EDB)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=RAPIPAGO
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'RAPIPAGO', amount, currency: 'ARS' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ RAPIPAGO) | Yes |
