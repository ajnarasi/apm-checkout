# SPEI — Checkout SDK Integration Spec
...
|---|---|---|
| **Button Label** | "Pay with SPEI" | "Pay with SPEI" |
| **Brand Color** | #004B87 | #004B87 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/spei.svg | — |
...
3. render(container) → Render branded "SPEI" button (#004B87)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=SPEI
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'SPEI', amount, currency: 'MXN' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ SPEI) | Yes |
