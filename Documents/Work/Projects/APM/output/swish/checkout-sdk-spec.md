# Swish — Checkout SDK Integration Spec
...
|---|---|---|
| SE | SEK | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with Swish" | "Pay with Swish" |
| **Brand Color** | #F8B71C | #F8B71C |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/swish.svg | — |
...
3. render(container) → Render branded "Swish" button (#F8B71C)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=SWISH
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'SWISH', amount, currency: 'SEK' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ SWISH) | Yes |
