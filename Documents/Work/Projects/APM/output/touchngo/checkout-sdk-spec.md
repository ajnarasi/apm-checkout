# Touch 'n Go — Checkout SDK Integration Spec
...
|---|---|---|
| MY | MYR | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with Touch 'n Go" | "Pay with Touch 'n Go" |
| **Brand Color** | #005ABB | #005ABB |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/touchngo.svg | — |
...
3. render(container) → Render branded "Touch 'n Go" button (#005ABB)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=TOUCHNGO
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'TOUCHNGO', amount, currency: 'MYR' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ TOUCHNGO) | Yes |
