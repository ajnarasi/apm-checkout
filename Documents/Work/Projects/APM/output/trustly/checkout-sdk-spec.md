# Trustly — Checkout SDK Integration Spec
...
|---|---|---|
| DE | EUR | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with Trustly" | "Pay with Trustly" |
| **Brand Color** | #0EE06E | #0EE06E |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/trustly.svg | — |
...
3. render(container) → Render branded "Trustly" button (#0EE06E)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=TRUSTLY
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'TRUSTLY', amount, currency: 'EUR' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ TRUSTLY) | Yes |
