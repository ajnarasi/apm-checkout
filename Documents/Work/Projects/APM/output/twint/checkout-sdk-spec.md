# TWINT — Checkout SDK Integration Spec
...
|---|---|---|
| CH | CHF | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with TWINT" | "Pay with TWINT" |
| **Brand Color** | #000000 | #000000 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/twint.svg | — |
...
3. render(container) → Render branded "TWINT" button (#000000)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=TWINT
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'TWINT', amount, currency: 'CHF' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ TWINT) | Yes |
