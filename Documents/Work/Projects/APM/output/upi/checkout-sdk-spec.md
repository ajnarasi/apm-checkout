# UPI — Checkout SDK Integration Spec
...
|---|---|---|
| IN | INR | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with UPI" | "Pay with UPI" |
| **Brand Color** | #5F259F | #5F259F |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/upi.svg | — |
...
3. render(container) → Render branded "UPI" button (#5F259F)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=UPI
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'UPI', amount, currency: 'INR' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ UPI) | Yes |
