# Vipps — Checkout SDK Integration Spec
...
|---|---|---|
| NO | NOK | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with Vipps" | "Pay with Vipps" |
| **Brand Color** | #FF5B24 | #FF5B24 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/vipps.svg | — |
...
3. render(container) → Render branded "Vipps" button (#FF5B24)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=VIPPS
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'VIPPS', amount, currency: 'NOK' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ VIPPS) | Yes |
