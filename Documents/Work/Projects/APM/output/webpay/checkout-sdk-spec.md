# Webpay — Checkout SDK Integration Spec
...
|---|---|---|
| CL | CLP | Primary market |

### Button/UI Configuration

| Property | Options | Default |
|---|---|---|
| **Button Label** | "Pay with Webpay" | "Pay with Webpay" |
| **Brand Color** | #FF0000 | #FF0000 |
| **Button Styles** | Standard PPRO button | — |
| **Logo URL** | /logos/webpay.svg | — |
...
3. render(container) → Render branded "Webpay" button (#FF0000)
4. authorize(paymentData) → POST /api/ppro/charge with paymentMethod=WEBPAY
...
6. getServerHandoff() → { endpoint: '/api/ppro/charge', method: 'POST', body: { paymentMethod: 'WEBPAY', amount, currency: 'CLP' } }
...
| paymentMethod.provider | paymentMethod | MAP_ENUM (→ WEBPAY) | Yes |
